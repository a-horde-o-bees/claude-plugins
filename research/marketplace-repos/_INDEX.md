...
- Context resources ([../marketplace-context-resources/](../marketplace-context-resources/)) answer schema / docs-prescription questions; per-repo files record what each repo *did*.
