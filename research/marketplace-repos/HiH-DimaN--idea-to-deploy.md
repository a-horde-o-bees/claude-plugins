...
- **Pitfalls observed**:
  ...
  - **Non-schema `images: [url]` field** on the plugin entry (value: `https://raw.githubusercontent.com/hihol-labs/idea-to-deploy/main/docs/demo.svg`). Not documented in the Claude Code marketplace reference surveyed in `research/marketplace-context-resources/docs-plugin-marketplaces.md`; permissive JSON consumers ignore it, but a strict validator would reject it. Acts as a de-facto custom "marketing asset" carrier.
