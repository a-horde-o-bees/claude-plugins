...
├── .claude/
│   ├── rules/                   — deployed rule files (gitignored; regenerated by /ocd:plugin install)
│   ├── conventions/             — deployed convention files (gitignored; regenerated by /ocd:plugin install)
