...
8. Present review gate:
    ...
    6. If user requests adjustments:
        1. If version change: update {final-version}, re-validate per step 7, re-render bump axis interpretation
        ...
        3. Re-present (go to step 8.1)
    7. Loop until approved
9. On approval, execute the release:
