...
Include what a user needs to get started and be productive. Exclude technical internals (layers, schema, design patterns) — that belongs in architecture.md.

## Nesting

When a system contains subsystems, describe each subsystem's purpose — what it does and how it relates to the whole. Do not re-explain the subsystem's installation, configuration, or usage details; link to the subsystem's own `README.md`.
