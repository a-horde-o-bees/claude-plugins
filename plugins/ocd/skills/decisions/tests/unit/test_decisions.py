...
Exercises the `skills.decisions` package directly — the MCP server
(`servers/decisions.py`) is a thin wrapper that delegates here, so
...
import skills.decisions as decisions
