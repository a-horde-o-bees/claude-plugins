# Plugin: Permissions Setup

Optional subflow invoked from `/ocd:plugin guided` when the user opts into permissions configuration. Deploys plugin-recommended permission patterns to the chosen scope, then optionally cleans redundant patterns from the opposite scope.
