...
2. Read `${CLAUDE_PLUGIN_ROOT}/skills/navigator/references/description-guidelines.md`
3. Sync structure — bash: `python3 ${CLAUDE_PLUGIN_ROOT}/run.py lib.navigator scan {target}`
