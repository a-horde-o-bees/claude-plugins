...
Orchestrator rejects any Defect fix that would change control flow within loops, STOP/EXIT paths, or variable scope across loop boundaries — reclassify as Observation.
