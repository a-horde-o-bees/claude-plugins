...
live under `<plugin>/shared/` rather than here, because setup is opt-in
and dormant by default. The canonical sources at project-root `shared/`
propagate into every plugin's own `shared/` via `.githooks/pre-commit`.
