...
3. Present findings:
  ...
  - Include concepts that might reveal user's true core intent — initial description sometimes adjacent to actual need
...
23. As entities encountered, assess against scope criteria before registering:
...
All roles share same table, notes, URLs, and provenance. Role determines how agents interact with entity and what notes capture.
