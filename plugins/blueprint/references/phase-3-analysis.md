...
```
references/research.db (measures added)
...
- `docs/6-domain-knowledge.md` for landscape context
...
- `references/analysis-interpretation.md` — goal-aligned interpretation, practices to adopt with effectiveness evidence
