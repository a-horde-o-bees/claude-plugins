...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/research/scripts/research_cli.py register-batch --json '[
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/research/scripts/research_cli.py remove notes --entity-id {directory_id} --note-ids PROGRESS_NOTE_ID --db references/research.db
python3 ${CLAUDE_PLUGIN_ROOT}/skills/research/scripts/research_cli.py upsert notes --entity-id {directory_id} --notes "[CRAWL PROGRESS]: Processed pages 1-N of M. X entities registered. Resume on page N+1." --db references/research.db
```
