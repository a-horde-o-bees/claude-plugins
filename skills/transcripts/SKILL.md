---
name: transcripts
description: Query Claude Code session transcripts as structured data — projects, sessions, exchanges, and cross-session topic blocks with time accounting and full chat content. Use when analyzing past-session history or producing per-project billable-time reports.
