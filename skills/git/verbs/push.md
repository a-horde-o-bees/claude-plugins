...
2. If BLOCKED (branch mismatch, detached HEAD, or a rebase conflict): surface it and stop — the driver has already left the tree safe (conflicted rebases are aborted).
