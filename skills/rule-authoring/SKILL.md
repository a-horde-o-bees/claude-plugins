---
name: rule-authoring
description: Use when authoring a rule, principle, or directive that governs agent behavior — to raise the odds it binds on the right cases, and to route load-bearing behavior to mechanical enforcement rather than wording.
---
