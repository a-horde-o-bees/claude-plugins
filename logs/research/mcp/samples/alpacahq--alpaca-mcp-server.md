...
exact last commit date, streamable-http auth flow (none? API key? shared secret?), whether there's a Docker Hub published image, OpenAPI spec origin (internal or published), exact async usage
